...
\begin{exercise}
    ...
    \begin{enumerate}
    \item $\vect{v}_1 = \startmat{r} 2 \\ -2 \\ -10\stopmat$ \wordChoice{\choice{will work}\choice[correct]{won't work}}
    \begin{problem}
    ...
    \item $\vect{v}_3 = \startmat{r} 10 \\ -10 \\ 14\stopmat$ \wordChoice{\choice{will work}\choice[correct]{won't work}}
    ...
    \begin{problem}
        ...
        \begin{equation*}
        \answer{-1}\startmat{r} -6 \\ 6 \\ -2\stopmat + \answer{1}\startmat{r} 4 \\ -4 \\ 12\stopmat + \startmat{r} 10 \\ -10 \\ 14\stopmat = \startmat{r} 0 \\ 0 \\ 0\stopmat
        \end{equation*}
