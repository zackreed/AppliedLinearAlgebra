...
\begin{center}
  \includegraphics[width=30.1cm, height=6.47cm]{navigation1.png}
\end{center}

When in doubt, just type ximera.osu.edu/appliedlinearalgebra in your browser to get to an error screen.

\begin{center}
  \includegraphics[width=30.1cm, height=6.47cm]{navigation2.png}
\end{center}
