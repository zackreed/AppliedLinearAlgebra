...
\begin{solution}
  ...
  Then, again since a matrix is an array of vectors, we can add matrices of the same size together.
    ...
    If you entered this correctly, you the Hawaiian population of South Dakota in 2024 should be $\answer[tolerance=1]{544.5}$, found at $P_{11,5}$.
...
\texttt{average\_midwest} = $[\answer[tolerance=.1]{4.5},\answer[tolerance=.1]{.6},\answer[tolerance=.1]{0},\answer[tolerance=.1]{0.2},\answer[tolerance=.1]{0},\answer[tolerance=.1]{0.4}]$
...
\texttt{average\_state} = $\begin{pmatrix}
  \answer[tolerance=.1]{.5}\\
  \answer[tolerance=.1]{2.1}\\
  \answer[tolerance=.1]{1.1}\\
  \answer[tolerance=.1]{.5}\\
  \answer{1.7}\\
  \answer[tolerance=.1]{.9}\\
  \answer[tolerance=.1]{1}\\
  \answer[tolerance=.1]{.1}\\
  \answer[tolerance=.1]{.3}\\
  \answer[tolerance=.1]{1.9}\\
  \answer[tolerance=.1]{.1}\\
  \answer[tolerance=.1]{1}
\end{pmatrix}$
