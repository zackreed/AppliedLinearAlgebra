...
\begin{itemize}
    \item First, the three planes could intersect at a single point, giving us \wordChoice{\choice[correct]{a unique solution.}\choice{infinitely many solutions.}\choice{no solutions.}}
    \begin{center}
        ...
        \fill[] (0,0,0) circle (0.1cm);
            \end{tikzpicture}
        \end{center}
    \item Second, the three planes can intersect in a line, forming a paddle-wheel shape.  In this case, every point along the line of intersection is a solution to the system, giving us \wordChoice{\choice{a unique solution.}\choice[correct]{infinitely many solutions.}\choice{no solutions.}}.
        \begin{center}
        \tdplotsetmaincoords{70}{130}
                \begin{tikzpicture}
            ...
            \end{tikzpicture}
            \end{center}
    \item Finally, the three planes can coincide.  If this is the case, we have \wordChoice{\choice{a unique solution.}\choice[correct]{infinitely many solutions.}\choice{no solutions.}}.
...
There are four ways for a system to be inconsistent (meaning no solution).  They are depicted below.
%\begin{center}[4in]
\begin{center}
\tdplotsetmaincoords{70}{130}
    \begin{tikzpicture}
...
In the next section, we'll apply these ideas to the notion of matrix inverses, which take a much more intentional orientation towards interpreting these operations for matrices, and determining whether the matrix equation 
