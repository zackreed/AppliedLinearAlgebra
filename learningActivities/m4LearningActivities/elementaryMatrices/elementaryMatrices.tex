...
%% SO A PRE-SYSTEMS section will involve just building up a few matrices from elementary matrices, and then setting up the need to sovle the inverse problem. Then we'll return here. 
