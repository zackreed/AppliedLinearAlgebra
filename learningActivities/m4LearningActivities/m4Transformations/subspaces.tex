...
Hence, the line $\mbox{span}\left(\begin{bmatrix}1\\2\end{bmatrix}\right)$ \wordChoice{\choice[correct]{is}\choice{is not}} a subspace of \wordChoice{\choice[correct]{$\RR^2$}\choice{$\RR^3$}}, as are $\mbox{im}(T)$ and $\mbox{col}(A)$, where $T$ is the transformation associated with $A$.
...
\begin{example}
  ...
  This planar null space \wordChoice{\choice[correct]{is}\choice{is not}} a subspace of \wordChoice{\choice{$\RR^2$}\choice{$\RR^4$}\choice[correct]{$\RR^5$}}.
...
is the set of \wordChoice{\choice{input}\choice[correct]{output}} vectors.

Hence, the line (aka $\mbox{span}\left(\begin{bmatrix}1\\2\end{bmatrix}\right)$) is a subspace of the \wordChoice{\choice{domain}\choice[correct]{co-domain}}. 
...
We also found that (do it again using \texttt{rref} if you forget our past work on this)

$$\mbox{rank}(T)=\mbox{dim}(\mbox{im}(T))=\mbox{dim}(\mbox{col}(A))=\mbox{rank}(A)=\answer{3}$$
and

$$\mbox{nullity}(T)=\mbox{dim}(\mbox{ker}(T))=\mbox{dim}(\mbox{null}(A))=\mbox{nullity}(A)=\answer{2}$$
 
You might notice that
$$\mbox{rank}(T)+\mbox{nullity}(T)=3+2=\answer{5}=\mbox{dim}(\RR^5),$$
...
\choice[correct]{$dim(\mbox{row}(A))=2$}
...
Which vectors are in the kernel of $T$? (More than one right answer).
