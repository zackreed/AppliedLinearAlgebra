...
\begin{solution}
  ...
  \begin{equation*}
    ...
    = \startmat{c} 1\\2\\0\\0 \stopmat
    + t\,\startmat{c} 1\\0\\0\\1 \stopmat
    + s\,\startmat{c} -1\\-1\\1\\0 \stopmat.
  \end{equation*}
...
\begin{example}{Finding the normal equation of a plane}{normal-equation}
  ...
  and orthogonal to $\vect{n}=\startmat{c}2,1,1\stopmat^T$.
\end{example}

\begin{solution}
  Let $\vect{p}=\startmat{c}1,3,0\stopmat^T$ be the position vector of $P$, and let
  $\vect{q}=\startmat{c}x,y,z\stopmat^T$ be the position vector of some arbitrary
  ...
  \begin{equation*}
    \startmat{c}2\\1\\1\stopmat
    \dotprod
    \startmat{c}x\\y\\z\stopmat
    =
    \startmat{c}2\\1\\1\stopmat
    \dotprod
    \startmat{c}1\\3\\0\stopmat.
  \end{equation*}
